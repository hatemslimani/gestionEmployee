...
<body>
	<div class="container">
		...
		<form action="${pageContext.request.contextPath}/employee"
			method="get" id="seachEmployeeForm" role="form">
		...
		<form action="${pageContext.request.contextPath}/employee"
			method="post" id="employeeForm" role="form">
					...
					<table class="table table-striped">
						...
						<c:forEach var="employee" items="${employeeList}">
							...
							<tr class="${classSucess}">
								<td><a
									href="${pageContext.request.contextPath}/employee?idEmployee=${employee.id}&searchAction=searchById">${employee.id}</a>
								</td>
								<td>${employee.name}</td>
